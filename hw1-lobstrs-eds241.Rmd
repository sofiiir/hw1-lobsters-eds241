...
perc_lob_inc <- round((1 - mpa_treat) *100, 2)

```
There are on average approximately `r lobster_count` in non-MPA sites according to the Poisson regression model. There is an approximate `r perc_lob_inc` change in the percentage of lobsters in MPA sites on average. 
