...
spiny_counts |> 
    group_by(site) |> 
ggplot() +
    geom_density_ridges(aes(x = count, y = site, color = site)) +
    labs(x = "Count",
         y = "Site",
...
spiny_counts |> 
    group_by(mpa) |> 
ggplot() +
    geom_violin(aes(x = mpa, y = count, color = mpa)) +
    labs(x = "MPA",
         y = "Count",
...
spiny_counts |> 
    group_by(year) |> 
ggplot() +
    geom_jitter(aes(x = count, y = year, color = year)) +
    labs(x = "Count",
         y = "Site",
         title = "California Spiny Lobster (*Panulirus Interruptus*) Count by Site")  
...
spiny_counts |> 
    group_by(mpa) |> 
    ggplot() +
    geom_density(aes(x = size_mm, y = mpa))
```
